...
export default function ActivityLogs() {
    ...
    const getActionColor = (action) => {
        switch (action) {
            ...
            case "REGISTER": return "bg-purple-100 text-purple-700";
            case "UPLOAD": return "bg-emerald-100 text-emerald-700";
            case "DELETE_FILE": return "bg-orange-100 text-orange-700";
            case "DELETE_USER": return "bg-red-100 text-red-700";
